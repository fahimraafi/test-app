<div>
    ...
    <form wire:submit='save' class="max-w-sm mx-auto" enctype="multipart/form-data">
        ...
        <div class="mb-5">
            <label for="image" class="block mb-2 text-sm font-medium text-gray-900 dark:text-black">Profile
                Photo</label>
        ...
        @if ($image)
            <img class="rounded w-10 h-10 mt-3 block" src="{{ $image->temporaryURL('') }}" alt="">
        @endif
